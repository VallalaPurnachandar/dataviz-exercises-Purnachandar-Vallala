...
# 5-SECOND TEST: KPI row at top tells the story in 5 seconds.
# Median price + delta vs overall + cheapest area = the key findings.
# Charts provide the supporting detail.
